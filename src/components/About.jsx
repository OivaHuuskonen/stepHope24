...
const About = () => {
  ...
  <PageContent>
    {/*<div className='text-[#679186] text-justify text-lg md:text-xl'>
    <div className='text-[#679186] text-4xl font-bold sm-text-right'>*/}
    ...
    <div>
      <p className="text-[#000000] text-justify text-base md:text-lg">Ohjelma on tarkoitettu miehille ja naisille, jotka kasvoivat alkoholistisissa tai toimintahäiriöisissä 
            perheissä ja jotka haluavat tervehtyä ja tiedostaa itselleen tuhoisat käyttäytymismallinsa jakamalla
